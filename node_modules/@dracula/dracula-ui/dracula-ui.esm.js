...
var borderColors = /*#__PURE__*/mapValues(colors, function (className) {
  return className.replace('-bg-', '-border-');
});
var glowColors = /*#__PURE__*/mapValues(colors, function (className) {
...
var Text = function Text(props) {
  var size = props.size,
      ...
      as = props.as,
      color = props.color,
      htmlProps = _objectWithoutPropertiesLoose(props, ["size", "weight", "lineHeight", "as", "color"]);

  var finalProps = _extends({}, htmlProps, {
    className: cx.apply(void 0, ["drac-text", props.className, textSizes[size != null ? size : 'md'], textWeights[weight != null ? weight : 'normal'], lineHeights[lineHeight != null ? lineHeight : 'md'], textColors[color != null ? color : 'white']].concat(paddingMixin(props), marginMixin(props)))
  });
...
var Anchor = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var size = props.size,
      ...
      htmlProps = _objectWithoutPropertiesLoose(props, ["size", "weight", "color", "hoverColor"]);
...
var Paragraph = function Paragraph(props) {
  var size = props.size,
      ...
      lineHeight = props.lineHeight,
      color = props.color,
      htmlProps = _objectWithoutPropertiesLoose(props, ["size", "weight", "lineHeight", "color"]);
...
function Box(props) {
  var color = props.color,
      ...
      htmlProps = _objectWithoutPropertiesLoose(props, ["color", "glowColor", "borderColor", "rounded", "as"]);

  var finalProps = _extends({}, htmlProps, {
    className: cx.apply(void 0, ["drac-box", props.className, color && colors[color], glowColor && glowColors[glowColor], borderColor && borderColors[borderColor], rounded && roundedBorders[rounded]].concat(paddingMixin(props), marginMixin(props)))
  });
...
var Button = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var textColorClass = overrideTextColor ? textColors[color != null ? color : 'green'] : undefined;
  var backgroundClass = colors[color != null ? color : 'green'];
...
var Badge = function Badge(props) {
  ...
  var textColorClass = overrideTextColor ? textColors[color] : undefined;
  var backgroundClass = colors[color];
  ...
  return React.createElement("span", Object.assign({
    ...
    color: overrideTextColor ? props.color : 'black'
  }, children));
};
...
var Input = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var color = props.color,
      size = props.size,
      variant = props.variant,
      htmlProps = _objectWithoutPropertiesLoose(props, ["color", "size", "variant"]);

  var finalProps = _extends({}, htmlProps, {
    className: cx.apply(void 0, ["drac-input", props.className, variant && inputVariants[variant], size && typeof size === 'string' && inputSizes[size], color && inputColors[color]].concat(paddingMixin(props), marginMixin(props)))
  });
...
export { Anchor, Avatar, AvatarBorderVariants, AvatarVariants, Badge, Box, Button, Card, Checkbox, Divider, Heading, Input, List, Paragraph, Radio, Select, Switch, Table, Tabs, Text, baseColors, baseTextColors, borderColors, buttonSizes, buttonVariants, cardOrientations, cardVariants, checkboxColors, cleanProps, colorUtilities, colors, dividerColors, glowColors, gradientColors, headingColors, headingSizes, hoverColors, inputColors, inputSizes, inputVariants, lineHeights, listColors, listVariants, marginMixin, paddingMixin, radioColors, roundedBorders, selectColors, selectSizes, selectVariants, spacingUtilities, supportColors, switchColors, tableColors, tableVariants, tabsColors, textColors, textSizes, textWeights };
